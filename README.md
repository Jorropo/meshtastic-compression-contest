...
| `flate_std` | 1.1273 |
| `zstd_klauspost` | 1.2116 |
| `zlib_klauspost` | 1.2120 |
| `zlib_std` | 1.3005 |
| `zstd_klauspost=dict_16384_brute` | 1.3169 |
| `zstd_klauspost=dict_256_brute` | 1.3271 |
| `zstd_klauspost=dict_512_brute` | 1.3271 |
| `zstd_klauspost=dict_1024_brute` | 1.3275 |
| `zstd_klauspost=dict_2048_brute` | 1.3275 |
| `zstd_klauspost=dict_4096_brute` | 1.3275 |
| `zstd_klauspost=dict_8192_brute` | 1.3275 |
| `lz4_pierrec` | 1.4229 |
| `s2_klauspost` | 1.5068 |
...
|------------|--------------------------------------|
| `zstd_klauspost=dict_16384_brute` | 0.9201 |
| `zstd_klauspost=dict_8192_brute` | 0.9941 |
...
| `zstd_klauspost=dict_4096_brute` | 1.0572 |
| `flate_klauspost` | 1.0660 |
| `rle_inkyblackness` | 1.0849 |
| `zstd_klauspost=dict_2048_brute` | 1.1159 |
| `flate_std` | 1.1292 |
| `lzw_std` | 1.1484 |
| `shoco_TextEn_tmthrgd` | 1.1694 |
| `zstd_klauspost=dict_1024_brute` | 1.1701 |
| `shoco_WordsEn_tmthrgd` | 1.1705 |
| `shoco_Emails_tmthrgd` | 1.1718 |
| `shoco_FilePath_tmthrgd` | 1.1728 |
| `zstd_klauspost` | 1.1833 |
| `zlib_klauspost` | 1.1903 |
| `zstd_klauspost=dict_512_brute` | 1.2255 |
| `smaz_cespare` | 1.2517 |
| `zlib_std` | 1.2535 |
| `zstd_klauspost=dict_256_brute` | 1.2580 |
| `lz4_pierrec` | 1.3083 |
| `s2_klauspost` | 1.3701 |
